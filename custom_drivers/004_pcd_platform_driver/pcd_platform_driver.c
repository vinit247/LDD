...
static void __exit pcdev_platform_driver_cleanup(void)
{
...
module_exit(pcdev_platform_driver_cleanup);

module_platform_driver(pcd_platform_driver);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("VINIT");
MODULE_DESCRIPTION("A pseudo character driver which handle n platform pcdevs");
